...
const ThirdComponent = () => {
  ...
  return (
    <Parallax
      className=" font-raleway text-4xl items-center text-center relative h-[100vh] px-5"
      ...
      strength={800}
    >
      <div className="flex flex-row mt-48 xl:mt-40 ">
        <Image
          ...
          alt="resume"
        />
        <div className="flex flex-col text-xl font-raleway ml-10">
          <h1
            data-aos="fade-up"
            className="mt-[50px] pr-10 text-xl md:text-2xl text-start font-bold font-raleway xl:text-4xl"
          >
            EDIT YOUR RESUME AS YOU LIKE
          </h1>
          <p
            data-aos="slide-up"
            className="text-lg justify-center text-start mt-10 font-raleway xl:text-2xl "
          >
